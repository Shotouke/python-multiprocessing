...
if __name__ == "__main__":
    ...
    testFile = 't'      # A reasonable size file for testing.
    prefix = 'tt' # Prefix for shares of file.
    names = py_ecc.file_ecc.EncodeFile(testFile,prefix,8,2) # break into N=15 pieces

    decList = map(lambda x: prefix + '.p_' + `x`,[1,2,3,4,5,6,7])
    decodedFile = 'a' # Choose where we want reconstruction to go.
